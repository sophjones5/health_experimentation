...
st.markdown(f"<h1 style='text-align: center; color: white; font-size:80px;'>Effect of {st.session_state.experiment} on your health</h1>", unsafe_allow_html=True)
...
st.markdown("<h2 style='text-align: center; color: white; font-size:50px;'>Average sleep scores</h2>", unsafe_allow_html=True)
...
st.markdown("<h2 style='text-align: center; color: white; font-size:50px;'>Average Percentage of Rem sleep</h2>", unsafe_allow_html=True)
...
st.markdown("<h2 style='text-align: center; color: white; font-size:50px;'>Average night HR</h2>", unsafe_allow_html=True)
col1, col2 = st.columns(2)
...
st.markdown("<h2 style='text-align: center; color: white; font-size:50px;'>Average hrv</h2>", unsafe_allow_html=True)
col1, col2 = st.columns(2)
